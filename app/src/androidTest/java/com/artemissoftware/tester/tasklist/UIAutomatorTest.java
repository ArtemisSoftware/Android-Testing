...
import com.artemissoftware.tester.tasklist.CreateTaskActivity;
...
public class UIAutomatorTest {
    ...
    public void validHomeButtonPressPqostLogin() {
        ...
        Intent i = new Intent();
        i.setClassName("com.artemissoftware.tester",  "com.artemissoftware.tester.tasklist.TaskListActivity");
